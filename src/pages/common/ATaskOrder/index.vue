...
const handleDispatch = (index: number, row: User) => { };
  ...
  <div class="main">
    ...
    <el-table :data="tableData" table-layout="fixed" size="large" class="table">
      ...
      <el-table-column label="操作" align="center" header-align="center">
        <template #default="scope">
          <el-popconfirm confirm-button-text="是" cancel-button-text="否" icon-color="#626AEF" title="是否确定下发?"
            @confirm="handleDispatch(scope.$index, scope.row)">
            <template #reference>
